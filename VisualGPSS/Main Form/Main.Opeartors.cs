        ...
        private void ToolBoxItemClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                creatingOperator = control.Name switch
                {
                    ...
                    "assembleButton" => new(CreateBlock, "ASSEMBLE"),
                    "gatherButton" => new(CreateBlock, "GATHER"),
                    "adoptButton" => new(CreateBlock, "ADOPT"),
                    "matchButton" => new(CreateBlock, "MATCH"),
                    "loopButton" => new(CreateBlock, "LOOP"),
                    "funavailButton" => new(CreateBlock, "FUNAVAIL"),
                    "favailButton" => new(CreateBlock, "FAVAIL"),
                    "sunavailButton" => new(CreateBlock, "SUNAVAIL"),
                    "savailButton" => new(CreateBlock, "SAVAIL"),
                    //"codeBlockButton" => new(),
